...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'ℹ️ Table capsters already exists, skipping...';
    
    -- Update existing capsters table to add barbershop_id if missing
    IF NOT EXISTS (
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '✅ ========================================';
  RAISE NOTICE '✅ BALIK.LAGI ONBOARDING ENHANCEMENT COMPLETE!';
  RAISE NOTICE '✅ ========================================';
  RAISE NOTICE '✅ All tables created successfully';
  RAISE NOTICE '✅ All RLS policies applied';
  RAISE NOTICE '✅ All functions created';
  RAISE NOTICE '✅ Database ready for onboarding flow!';
  RAISE NOTICE '';
END $$;
